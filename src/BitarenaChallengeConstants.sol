...
uint256 constant DELAY_START_VICTORY_CLAIM_BY_DEFAULT = 10 minutes; //After startAt
uint256 constant DELAY_END_VICTORY_CLAIM_BY_DEFAULT = 1 hours; //After startVictoryclaim

uint256 constant DELAY_START_DISPUTE_PARTICIPATION_BY_DEFAULT = 10 minutes; //After endVictoryclaim
